...
shared 2022–2024 development dataset is closed to further candidate research to prevent
data-snooping. The safe project default is `NEUTRAL`; it is not investment advice or a trading
instruction.
